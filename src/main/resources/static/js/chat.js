...
$(function () {
    ...
    ws.onmessage = function (evt) {
        ...
        //jsonData 格式举例（需要判断是否是系统消息）：{“systemMsgFlag”: false, "fromName": "mars", "message": “你在哪里呀？”}
        ...
        if (jsonData.systemMsgFlag) {
            ...
            //不是系统消息，是发送给指定用户的消息,示例值：{“systemMsgFlag”: false, "fromName": "mars", "message": “你在哪里呀？”}
